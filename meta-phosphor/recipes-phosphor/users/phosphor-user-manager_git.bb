...
GROUPADD_PARAM_${PN} = "priv-admin; priv-operator; priv-user; priv-oemibmserviceagent "
GROUPADD_PARAM_phosphor-ldap = "priv-admin; priv-operator; priv-user; priv-oemibmserviceagent "
