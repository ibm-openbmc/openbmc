...
FILES_phosphor-cooling-type_append_mowgli = " ${bindir}/phosphor-cooling-type"
SYSTEMD_SERVICE_phosphor-cooling-type_append_mowgli = " ${TMPL_COOLING}"
SYSTEMD_LINK_phosphor-cooling-type_append_mowgli = " ${@compose_list(d, 'FMT_COOLING', 'OBMC_CHASSIS_INSTANCES')}"
...
SYSTEMD_ENVIRONMENT_FILE_phosphor-cooling-type_append_mowgli = " ${@compose_list(d, 'COOLING_ENV_FMT', 'OBMC_CHASSIS_INSTANCES')}"
