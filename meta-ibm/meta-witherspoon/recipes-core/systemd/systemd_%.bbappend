...
SRC_URI_append_mihawk = " file://journald-storage-policy.conf"
SRC_URI_append_mihawk = " file://systemd-journald-override.conf"
SRC_URI_append_mihawk = " file://journald-size-policy.conf"

SRC_URI_append_mowgli = " file://journald-storage-policy.conf"
SRC_URI_append_mowgli = " file://systemd-journald-override.conf"
SRC_URI_append_mowgli = " file://journald-size-policy.conf"
...
FILES_${PN}_append_mihawk = " ${systemd_unitdir}/journald.conf.d/journald-storage-policy.conf"
FILES_${PN}_append_mihawk = " ${systemd_system_unitdir}/systemd-journald.service.d/systemd-journald-override.conf"
FILES_${PN}_append_mihawk = " ${systemd_unitdir}/journald.conf.d/journald-size-policy.conf"

FILES_${PN}_append_mowgli = " ${systemd_unitdir}/journald.conf.d/journald-storage-policy.conf"
FILES_${PN}_append_mowgli = " ${systemd_system_unitdir}/systemd-journald.service.d/systemd-journald-override.conf"
FILES_${PN}_append_mowgli = " ${systemd_unitdir}/journald.conf.d/journald-size-policy.conf"
