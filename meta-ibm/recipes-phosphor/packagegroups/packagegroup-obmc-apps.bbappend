...
RDEPENDS:${PN}-inventory:append:p10bmc = " ibm-vpd-parser openpower-fru-vpd openpower-occ-control phosphor-gpio-monitor-presence"
...
RDEPENDS:${PN}-extras:append:p10bmc = " pldm openpower-hw-diags srvcfg-manager biosconfig-manager phosphor-post-code-manager phosphor-host-postd debug-trigger libmctp panel"
